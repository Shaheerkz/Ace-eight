              ...
              <div className="row">
                <div className="services-content-wrp position-relative">
                  <div className="row">
                    ...
                    <div className="col-md-7 wrp" data-aos="fade-left">
                  ...
                  <div className="row mt-5 wrp">
                    <div className="col-12">
                      <div className="text-story text-center" data-aos="fade-down">
                        <h4>
                      ...
                      <div className="row mt-5">
                        <div className="col-md-6">
                          <div className="story-card" data-aos="fade-right">
                            ...
                            <div className="card-center my-4 position-relative">
                              <p className="text-white card-top position-absolute">
                                Customer Story
                              </p>
                        ...
                        <div className="col-md-6">
                          <div className="story-card" data-aos="fade-left">
                            <h5>Microservices Migration</h5>
                            <div className="card-center my-4 position-relative">
                              <p className="text-white card-top position-absolute">
                                Customer Story
